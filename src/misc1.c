...
#if defined(FEAT_SMARTINDENT) || defined(FEAT_VREPLACE) || defined(FEAT_LISP) || defined(FEAT_CINDENT) || defined(FEAT_COMMENTS)
    char_u      *p;
#endif
...
#if defined(FEAT_SEARCHPATH) || defined(FEAT_CMDL_COMPL)
/*
