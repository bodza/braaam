...
#if (defined(FEAT_WINDOWS) && defined(HAVE_DROP_FILE)) || (defined(FEAT_GUI_GTK) && defined(FEAT_DND)) || defined(FEAT_GUI_MSWIN) || defined(FEAT_GUI_MAC)
...
#if defined(FEAT_EX_EXTRA) || defined(FEAT_MENU)
/*
