...
EX(CMD_all,             "all",          ex_all,
                        ...
                        ADDR_LINES),
EX(CMD_amenu,           "amenu",        ex_ni,
                        RANGE|NOTADR|ZEROR|EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_anoremenu,       "anoremenu",    ex_ni,
                        RANGE|NOTADR|ZEROR|EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
...
EX(CMD_change,          "change",       ex_change,
                        ...
                        ADDR_LINES),
EX(CMD_cNext,           "cNext",        ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_cNfile,          "cNfile",       ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
...
EX(CMD_cabclear,        "cabclear",     ex_abclear,
                        EXTRA|TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_caddbuffer,      "caddbuffer",   ex_ni,
                        RANGE|NOTADR|WORD1|TRLBAR,
                        ADDR_LINES),
EX(CMD_caddexpr,        "caddexpr",     ex_ni,
                        NEEDARG|WORD1|NOTRLCOM|TRLBAR,
                        ADDR_LINES),
EX(CMD_caddfile,        "caddfile",     ex_ni,
                        TRLBAR|FILE1,
                        ADDR_LINES),
...
EX(CMD_catch,           "catch",        ex_catch,
                        EXTRA|SBOXOK|CMDWIN,
                        ADDR_LINES),
EX(CMD_cbuffer,         "cbuffer",      ex_ni,
                        BANG|RANGE|NOTADR|WORD1|TRLBAR,
                        ADDR_LINES),
EX(CMD_cc,              "cc",           ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_cclose,          "cclose",       ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR,
                        ADDR_LINES),
EX(CMD_cd,              "cd",           ex_cd,
...
EX(CMD_center,          "center",       ex_align,
                        ...
                        ADDR_LINES),
EX(CMD_cexpr,           "cexpr",        ex_ni,
                        NEEDARG|WORD1|NOTRLCOM|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_cfile,           "cfile",        ex_ni,
                        TRLBAR|FILE1|BANG,
                        ADDR_LINES),
EX(CMD_cfirst,          "cfirst",       ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_cgetfile,        "cgetfile",     ex_ni,
                        TRLBAR|FILE1,
                        ADDR_LINES),
EX(CMD_cgetbuffer,      "cgetbuffer",   ex_ni,
                        RANGE|NOTADR|WORD1|TRLBAR,
                        ADDR_LINES),
EX(CMD_cgetexpr,        "cgetexpr",     ex_ni,
                        NEEDARG|WORD1|NOTRLCOM|TRLBAR,
                        ADDR_LINES),
...
EX(CMD_cmapclear,       "cmapclear",    ex_mapclear,
                        EXTRA|TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_cmenu,           "cmenu",        ex_ni,
                        RANGE|NOTADR|ZEROR|EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_cnext,           "cnext",        ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_cnewer,          "cnewer",       ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR,
                        ADDR_LINES),
EX(CMD_cnfile,          "cnfile",       ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
...
EX(CMD_confirm,         "confirm",      ex_wrongmodifier,
                        NEEDARG|EXTRA|NOTRLCOM|CMDWIN,
                        ADDR_LINES),
EX(CMD_copen,           "copen",        ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR,
                        ADDR_LINES),
EX(CMD_cprevious,       "cprevious",    ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_cpfile,          "cpfile",       ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_cquit,           "cquit",        ex_cquit,
                        TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_crewind,         "crewind",      ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_cscope,          "cscope",       ex_ni,
                        EXTRA|NOTRLCOM|XFILE,
                        ADDR_LINES),
EX(CMD_cstag,           "cstag",        ex_ni,
                        BANG|TRLBAR|WORD1,
                        ADDR_LINES),
...
EX(CMD_cunabbrev,       "cunabbrev",    ex_abbreviate,
                        EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_cunmenu,         "cunmenu",      ex_ni,
                        EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_cwindow,         "cwindow",      ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR,
                        ADDR_LINES),
...
EX(CMD_display,         "display",      ex_display,
                        ...
                        ADDR_LINES),
EX(CMD_diffupdate,      "diffupdate",   ex_ni,
                        BANG|TRLBAR,
                        ADDR_LINES),
EX(CMD_diffget,         "diffget",      ex_ni,
                        RANGE|EXTRA|TRLBAR|MODIFY,
                        ADDR_LINES),
EX(CMD_diffoff,         "diffoff",      ex_ni,
                        BANG|TRLBAR,
                        ADDR_LINES),
EX(CMD_diffpatch,       "diffpatch",    ex_ni,
                        EXTRA|FILE1|TRLBAR|MODIFY,
                        ADDR_LINES),
EX(CMD_diffput,         "diffput",      ex_ni,
                        RANGE|EXTRA|TRLBAR,
                        ADDR_LINES),
EX(CMD_diffsplit,       "diffsplit",    ex_ni,
                        EXTRA|FILE1|TRLBAR,
                        ADDR_LINES),
EX(CMD_diffthis,        "diffthis",     ex_ni,
                        TRLBAR,
                        ADDR_LINES),
EX(CMD_digraphs,        "digraphs",     ex_digraphs,
                        EXTRA|TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_djump,           "djump",        ex_ni,
                        BANG|RANGE|DFLALL|WHOLEFOLD|EXTRA,
                        ADDR_LINES),
EX(CMD_dlist,           "dlist",        ex_ni,
...
EX(CMD_doautoall,       "doautoall",    ex_doautoall,
                        EXTRA|TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_drop,            "drop",         ex_ni,
                        FILES|EDITCMD|NEEDARG|ARGOPT|TRLBAR,
                        ADDR_LINES),
EX(CMD_dsearch,         "dsearch",      ex_ni,
                        BANG|RANGE|DFLALL|WHOLEFOLD|EXTRA|CMDWIN,
                        ADDR_LINES),
EX(CMD_dsplit,          "dsplit",       ex_ni,
                        BANG|RANGE|DFLALL|WHOLEFOLD|EXTRA,
                        ADDR_LINES),
...
EX(CMD_fixdel,          "fixdel",       do_fixdel,
                        TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_fold,            "fold",         ex_ni,
                        RANGE|WHOLEFOLD|TRLBAR|SBOXOK|CMDWIN,
                        ADDR_LINES),
EX(CMD_foldclose,       "foldclose",    ex_ni,
                        RANGE|BANG|WHOLEFOLD|TRLBAR|SBOXOK|CMDWIN,
                        ADDR_LINES),
EX(CMD_folddoopen,      "folddoopen",   ex_ni,
                        RANGE|DFLALL|NEEDARG|EXTRA|NOTRLCOM,
                        ADDR_LINES),
EX(CMD_folddoclosed,    "folddoclosed", ex_ni,
                        RANGE|DFLALL|NEEDARG|EXTRA|NOTRLCOM,
                        ADDR_LINES),
EX(CMD_foldopen,        "foldopen",     ex_ni,
                        RANGE|BANG|WHOLEFOLD|TRLBAR|SBOXOK|CMDWIN,
                        ADDR_LINES),
...
EX(CMD_helpclose,       "helpclose",    ex_helpclose,
                        RANGE|NOTADR|COUNT|TRLBAR,
                        ADDR_LINES),
EX(CMD_helpfind,        "helpfind",     ex_ni,
                        EXTRA|NOTRLCOM,
                        ADDR_LINES),
EX(CMD_helpgrep,        "helpgrep",     ex_ni,
                        EXTRA|NOTRLCOM|NEEDARG,
                        ADDR_LINES),
EX(CMD_helptags,        "helptags",     ex_helptags,
                        NEEDARG|FILES|TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_hardcopy,        "hardcopy",     ex_ni,
...
EX(CMD_if,              "if",           ex_if,
                        EXTRA|NOTRLCOM|SBOXOK|CMDWIN,
                        ADDR_LINES),
EX(CMD_ijump,           "ijump",        ex_ni,
                        BANG|RANGE|DFLALL|WHOLEFOLD|EXTRA,
                        ADDR_LINES),
EX(CMD_ilist,           "ilist",        ex_ni,
                        BANG|RANGE|DFLALL|WHOLEFOLD|EXTRA|CMDWIN,
                        ADDR_LINES),
...
EX(CMD_inoreabbrev,     "inoreabbrev",  ex_abbreviate,
                        EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_inoremenu,       "inoremenu",    ex_ni,
                        RANGE|NOTADR|ZEROR|EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_intro,           "intro",        ex_intro,
                        TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_isearch,         "isearch",      ex_ni,
                        BANG|RANGE|DFLALL|WHOLEFOLD|EXTRA|CMDWIN,
                        ADDR_LINES),
EX(CMD_isplit,          "isplit",       ex_ni,
                        BANG|RANGE|DFLALL|WHOLEFOLD|EXTRA,
                        ADDR_LINES),
...
EX(CMD_list,            "list",         ex_print,
                        ...
                        ADDR_LINES),
EX(CMD_lNext,           "lNext",        ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_lNfile,          "lNfile",       ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_last,            "last",         ex_last,
                        EXTRA|BANG|EDITCMD|ARGOPT|TRLBAR,
                        ADDR_LINES),
EX(CMD_language,        "language",     ex_ni,
                        EXTRA|TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_laddexpr,        "laddexpr",     ex_ni,
                        NEEDARG|WORD1|NOTRLCOM|TRLBAR,
                        ADDR_LINES),
EX(CMD_laddbuffer,      "laddbuffer",   ex_ni,
                        RANGE|NOTADR|WORD1|TRLBAR,
                        ADDR_LINES),
EX(CMD_laddfile,        "laddfile",     ex_ni,
                        TRLBAR|FILE1,
                        ADDR_LINES),
EX(CMD_later,           "later",        ex_later,
                        TRLBAR|EXTRA|NOSPC|CMDWIN,
                        ADDR_LINES),
EX(CMD_lbuffer,         "lbuffer",      ex_ni,
                        BANG|RANGE|NOTADR|WORD1|TRLBAR,
                        ADDR_LINES),
...
EX(CMD_lchdir,          "lchdir",       ex_cd,
                        BANG|FILE1|TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_lclose,          "lclose",       ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR,
                        ADDR_LINES),
EX(CMD_lcscope,         "lcscope",      ex_ni,
                        EXTRA|NOTRLCOM|XFILE,
                        ADDR_LINES),
...
EX(CMD_let,             "let",          ex_let,
                        EXTRA|NOTRLCOM|SBOXOK|CMDWIN,
                        ADDR_LINES),
EX(CMD_lexpr,           "lexpr",        ex_ni,
                        NEEDARG|WORD1|NOTRLCOM|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_lfile,           "lfile",        ex_ni,
                        TRLBAR|FILE1|BANG,
                        ADDR_LINES),
EX(CMD_lfirst,          "lfirst",       ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_lgetfile,        "lgetfile",     ex_ni,
                        TRLBAR|FILE1,
                        ADDR_LINES),
EX(CMD_lgetbuffer,      "lgetbuffer",   ex_ni,
                        RANGE|NOTADR|WORD1|TRLBAR,
                        ADDR_LINES),
EX(CMD_lgetexpr,        "lgetexpr",     ex_ni,
                        NEEDARG|WORD1|NOTRLCOM|TRLBAR,
                        ADDR_LINES),
EX(CMD_lgrep,           "lgrep",        ex_ni,
                        RANGE|NOTADR|BANG|NEEDARG|EXTRA|NOTRLCOM|TRLBAR|XFILE,
                        ADDR_LINES),
EX(CMD_lgrepadd,        "lgrepadd",     ex_ni,
                        RANGE|NOTADR|BANG|NEEDARG|EXTRA|NOTRLCOM|TRLBAR|XFILE,
                        ADDR_LINES),
EX(CMD_lhelpgrep,       "lhelpgrep",    ex_ni,
                        EXTRA|NOTRLCOM|NEEDARG,
                        ADDR_LINES),
EX(CMD_ll,              "ll",           ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_llast,           "llast",        ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_llist,           "llist",        ex_ni,
                        BANG|EXTRA|TRLBAR|CMDWIN,
                        ADDR_LINES),
...
EX(CMD_lnext,           "lnext",        ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_lnewer,          "lnewer",       ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR,
                        ADDR_LINES),
EX(CMD_lnfile,          "lnfile",       ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_loadview,        "loadview",     ex_ni,
                        FILE1|TRLBAR,
                        ADDR_LINES),
EX(CMD_loadkeymap,      "loadkeymap",   ex_ni,
                        CMDWIN,
                        ADDR_LINES),
...
EX(CMD_lockvar,         "lockvar",      ex_lockvar,
                        ...
                        ADDR_LINES),
EX(CMD_lolder,          "lolder",       ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR,
                        ADDR_LINES),
EX(CMD_lopen,           "lopen",        ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR,
                        ADDR_LINES),
EX(CMD_lprevious,       "lprevious",    ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_lpfile,          "lpfile",       ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
EX(CMD_lrewind,         "lrewind",      ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR|BANG,
                        ADDR_LINES),
...
EX(CMD_lunmap,          "lunmap",       ex_unmap,
                        EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_lua,             "lua",          ex_script_ni,
                        RANGE|EXTRA|NEEDARG|CMDWIN,
                        ADDR_LINES),
EX(CMD_luado,           "luado",        ex_ni,
                        RANGE|DFLALL|EXTRA|NEEDARG|CMDWIN,
                        ADDR_LINES),
EX(CMD_luafile,         "luafile",      ex_ni,
                        RANGE|FILE1|NEEDARG|CMDWIN,
                        ADDR_LINES),
EX(CMD_lvimgrep,        "lvimgrep",     ex_ni,
                        RANGE|NOTADR|BANG|NEEDARG|EXTRA|NOTRLCOM|TRLBAR|XFILE,
                        ADDR_LINES),
EX(CMD_lvimgrepadd,     "lvimgrepadd",  ex_ni,
                        RANGE|NOTADR|BANG|NEEDARG|EXTRA|NOTRLCOM|TRLBAR|XFILE,
                        ADDR_LINES),
EX(CMD_lwindow,         "lwindow",      ex_ni,
                        RANGE|NOTADR|COUNT|TRLBAR,
                        ADDR_LINES),
...
EX(CMD_match,           "match",        ex_match,
                        ...
                        ADDR_LINES),
EX(CMD_menu,            "menu",         ex_ni,
                        RANGE|NOTADR|ZEROR|BANG|EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_menutranslate,   "menutranslate", ex_ni,
                        EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
...
EX(CMD_mode,            "mode",         ex_mode,
                        WORD1|TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_mzscheme,        "mzscheme",     ex_script_ni,
                        RANGE|EXTRA|DFLALL|NEEDARG|CMDWIN|SBOXOK,
                        ADDR_LINES),
EX(CMD_mzfile,          "mzfile",       ex_ni,
                        RANGE|FILE1|NEEDARG|CMDWIN,
                        ADDR_LINES),
EX(CMD_next,            "next",         ex_next,
                        RANGE|NOTADR|BANG|FILES|EDITCMD|ARGOPT|TRLBAR,
                        ADDR_LINES),
EX(CMD_nbkey,           "nbkey",        ex_ni,
                        EXTRA|NOTADR|NEEDARG,
                        ADDR_LINES),
EX(CMD_nbclose,         "nbclose",      ex_ni,
                        TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_nbstart,         "nbstart",      ex_ni,
                        WORD1|TRLBAR|CMDWIN,
                        ADDR_LINES),
...
EX(CMD_nmapclear,       "nmapclear",    ex_mapclear,
                        EXTRA|TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_nmenu,           "nmenu",        ex_ni,
                        RANGE|NOTADR|ZEROR|EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_nnoremap,        "nnoremap",     ex_map,
                        EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_nnoremenu,       "nnoremenu",    ex_ni,
                        RANGE|NOTADR|ZEROR|EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
...
EX(CMD_noreabbrev,      "noreabbrev",   ex_abbreviate,
                        EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_noremenu,        "noremenu",     ex_ni,
                        RANGE|NOTADR|ZEROR|BANG|EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
...
EX(CMD_onoremap,        "onoremap",     ex_map,
                        EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_onoremenu,       "onoremenu",    ex_ni,
                        RANGE|NOTADR|ZEROR|EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
...
EX(CMD_previous,        "previous",     ex_previous,
                        ...
                        ADDR_LINES),
EX(CMD_promptfind,      "promptfind",   ex_ni,
                        EXTRA|NOTRLCOM|CMDWIN,
                        ADDR_LINES),
EX(CMD_promptrepl,      "promptrepl",   ex_ni,
                        EXTRA|NOTRLCOM|CMDWIN,
                        ADDR_LINES),
EX(CMD_profile,         "profile",      ex_ni,
                        BANG|EXTRA|TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_profdel,         "profdel",      ex_breakdel,
                        EXTRA|TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_psearch,         "psearch",      ex_ni,
                        BANG|RANGE|WHOLEFOLD|DFLALL|EXTRA,
                        ADDR_LINES),
EX(CMD_ptag,            "ptag",         ex_ni,
                        RANGE|NOTADR|BANG|WORD1|TRLBAR|ZEROR,
                        ADDR_LINES),
EX(CMD_ptNext,          "ptNext",       ex_ni,
                        RANGE|NOTADR|BANG|TRLBAR|ZEROR,
                        ADDR_LINES),
EX(CMD_ptfirst,         "ptfirst",      ex_ni,
                        RANGE|NOTADR|BANG|TRLBAR|ZEROR,
                        ADDR_LINES),
EX(CMD_ptjump,          "ptjump",       ex_ni,
                        BANG|TRLBAR|WORD1,
                        ADDR_LINES),
EX(CMD_ptlast,          "ptlast",       ex_ni,
                        BANG|TRLBAR,
                        ADDR_LINES),
EX(CMD_ptnext,          "ptnext",       ex_ni,
                        RANGE|NOTADR|BANG|TRLBAR|ZEROR,
                        ADDR_LINES),
EX(CMD_ptprevious,      "ptprevious",   ex_ni,
                        RANGE|NOTADR|BANG|TRLBAR|ZEROR,
                        ADDR_LINES),
EX(CMD_ptrewind,        "ptrewind",     ex_ni,
                        RANGE|NOTADR|BANG|TRLBAR|ZEROR,
                        ADDR_LINES),
EX(CMD_ptselect,        "ptselect",     ex_ni,
                        BANG|TRLBAR|WORD1,
                        ADDR_LINES),
...
EX(CMD_pwd,             "pwd",          ex_pwd,
                        TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_python,          "python",       ex_script_ni,
                        RANGE|EXTRA|NEEDARG|CMDWIN,
                        ADDR_LINES),
EX(CMD_pydo,            "pydo",         ex_ni,
                        RANGE|DFLALL|EXTRA|NEEDARG|CMDWIN,
                        ADDR_LINES),
EX(CMD_pyfile,          "pyfile",       ex_ni,
                        RANGE|FILE1|NEEDARG|CMDWIN,
                        ADDR_LINES),
EX(CMD_py3,             "py3",          ex_script_ni,
                        RANGE|EXTRA|NEEDARG|CMDWIN,
                        ADDR_LINES),
EX(CMD_py3do,           "py3do",        ex_ni,
                        RANGE|DFLALL|EXTRA|NEEDARG|CMDWIN,
                        ADDR_LINES),
EX(CMD_python3,         "python3",      ex_script_ni,
                        RANGE|EXTRA|NEEDARG|CMDWIN,
                        ADDR_LINES),
EX(CMD_py3file,         "py3file",      ex_ni,
                        RANGE|FILE1|NEEDARG|CMDWIN,
                        ADDR_LINES),
...
EX(CMD_runtime,         "runtime",      ex_runtime,
                        ...
                        ADDR_LINES),
EX(CMD_ruby,            "ruby",         ex_script_ni,
                        RANGE|EXTRA|NEEDARG|CMDWIN,
                        ADDR_LINES),
EX(CMD_rubydo,          "rubydo",       ex_ni,
                        RANGE|DFLALL|EXTRA|NEEDARG|CMDWIN,
                        ADDR_LINES),
EX(CMD_rubyfile,        "rubyfile",     ex_ni,
                        RANGE|FILE1|NEEDARG|CMDWIN,
                        ADDR_LINES),
EX(CMD_rundo,           "rundo",        ex_rundo,
                        NEEDARG|FILE1,
                        ADDR_LINES),
EX(CMD_rviminfo,        "rviminfo",     ex_ni,
                        BANG|FILE1|TRLBAR|CMDWIN,
                        ADDR_LINES),
...
EX(CMD_shell,           "shell",        ex_shell,
                        TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_simalt,          "simalt",       ex_ni,
                        NEEDARG|WORD1|TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_sign,            "sign",         ex_ni,
...
EX(CMD_snoremap,        "snoremap",     ex_map,
                        EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_snoremenu,       "snoremenu",    ex_ni,
                        RANGE|NOTADR|ZEROR|EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
...
EX(CMD_split,           "split",        ex_splitview,
                        BANG|FILE1|RANGE|NOTADR|EDITCMD|ARGOPT|TRLBAR,
                        ADDR_LINES),
EX(CMD_spellgood,       "spellgood",    ex_ni,
                        BANG|RANGE|NOTADR|NEEDARG|EXTRA|TRLBAR,
                        ADDR_LINES),
EX(CMD_spelldump,       "spelldump",    ex_ni,
                        BANG|TRLBAR,
                        ADDR_LINES),
EX(CMD_spellinfo,       "spellinfo",    ex_ni,
                        TRLBAR,
                        ADDR_LINES),
EX(CMD_spellrepall,     "spellrepall",  ex_ni,
                        TRLBAR,
                        ADDR_LINES),
EX(CMD_spellundo,       "spellundo",    ex_ni,
                        BANG|RANGE|NOTADR|NEEDARG|EXTRA|TRLBAR,
                        ADDR_LINES),
EX(CMD_spellwrong,      "spellwrong",   ex_ni,
                        BANG|RANGE|NOTADR|NEEDARG|EXTRA|TRLBAR,
                        ADDR_LINES),
...
EX(CMD_tabs,            "tabs",         ex_tabs,
                        TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_tcl,             "tcl",          ex_script_ni,
                        RANGE|EXTRA|NEEDARG|CMDWIN,
                        ADDR_LINES),
EX(CMD_tcldo,           "tcldo",        ex_ni,
                        RANGE|DFLALL|EXTRA|NEEDARG|CMDWIN,
                        ADDR_LINES),
EX(CMD_tclfile,         "tclfile",      ex_ni,
                        RANGE|FILE1|NEEDARG|CMDWIN,
                        ADDR_LINES),
EX(CMD_tearoff,         "tearoff",      ex_ni,
...
EX(CMD_view,            "view",         ex_edit,
                        BANG|FILE1|EDITCMD|ARGOPT|TRLBAR,
                        ADDR_LINES),
EX(CMD_vimgrep,         "vimgrep",      ex_ni,
                        RANGE|NOTADR|BANG|NEEDARG|EXTRA|NOTRLCOM|TRLBAR|XFILE,
                        ADDR_LINES),
EX(CMD_vimgrepadd,      "vimgrepadd",   ex_ni,
                        RANGE|NOTADR|BANG|NEEDARG|EXTRA|NOTRLCOM|TRLBAR|XFILE,
                        ADDR_LINES),
...
EX(CMD_vnew,            "vnew",         ex_splitview,
                        BANG|FILE1|RANGE|NOTADR|EDITCMD|ARGOPT|TRLBAR,
                        ADDR_LINES),
EX(CMD_vnoremenu,       "vnoremenu",    ex_ni,
                        RANGE|NOTADR|ZEROR|EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
...
EX(CMD_wqall,           "wqall",        do_wqall,
                        ...
                        ADDR_LINES),
EX(CMD_wsverb,          "wsverb",       ex_ni,
                        EXTRA|NOTADR|NEEDARG,
                        ADDR_LINES),
EX(CMD_wundo,           "wundo",        ex_wundo,
                        BANG|NEEDARG|FILE1,
                        ADDR_LINES),
EX(CMD_wviminfo,        "wviminfo",     ex_ni,
                        BANG|FILE1|TRLBAR|CMDWIN,
                        ADDR_LINES),
...
EX(CMD_xmapclear,       "xmapclear",    ex_mapclear,
                        EXTRA|TRLBAR|CMDWIN,
                        ADDR_LINES),
EX(CMD_xmenu,           "xmenu",        ex_ni,
                        RANGE|NOTADR|ZEROR|EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_xnoremap,        "xnoremap",     ex_map,
                        EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_xnoremenu,       "xnoremenu",    ex_ni,
                        RANGE|NOTADR|ZEROR|EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_xunmap,          "xunmap",       ex_unmap,
                        EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
EX(CMD_xunmenu,         "xunmenu",      ex_ni,
                        EXTRA|TRLBAR|NOTRLCOM|USECTRLV|CMDWIN,
                        ADDR_LINES),
