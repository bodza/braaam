...
#if defined(FEAT_DIFF) || defined(FEAT_FOLDING) || defined(FEAT_SPELL) || defined(FEAT_VERTSPLIT) || defined(FEAT_CLIPBOARD) || defined(FEAT_INS_EXPAND) || defined(FEAT_SYN_HL) || defined(FEAT_CONCEAL)
        ...
        options[] =
{
    {"aleph",       "al",   P_NUM|P_VI_DEF|P_CURSWANT,
                            ...
                            (char_u *)NULL, PV_NONE,
#endif
                            {(char_u *)224L, (char_u *)0L} SCRIPTID_INIT},
    ...
    {"ambiwidth",  "ambw",  P_STRING|P_VI_DEF|P_RCLR,
                            ...
                            {(char_u *)"single", (char_u *)0L} SCRIPTID_INIT},
    ...
    {"background",  "bg",   P_STRING|P_VI_DEF|P_RCLR,
                            (char_u *)&p_bg, PV_NONE,
                            {(char_u *)"light", (char_u *)0L} SCRIPTID_INIT},
    ...
    {"casemap",     "cmp",   P_STRING|P_VI_DEF|P_COMMA|P_NODUP,
                            ...
                            {(char_u *)"internal,keepascii", (char_u *)0L} SCRIPTID_INIT},
    ...
    {"encoding",    "enc",  P_STRING|P_VI_DEF|P_RCLR|P_NO_ML,
                            ...
                            {(char_u *)ENC_DFLT, (char_u *)0L} SCRIPTID_INIT},
    ...
    {"fileencodings","fencs", P_STRING|P_VI_DEF|P_COMMA,
                            ...
                            {(char_u *)"ucs-bom", (char_u *)0L} SCRIPTID_INIT},
    ...
    {"foldexpr",    "fde",  P_STRING|P_ALLOCED|P_VIM|P_VI_DEF|P_RWIN,
                            ...
                            {(char_u *)"0", (char_u *)NULL} SCRIPTID_INIT},
    ...
    {"foldtext",    "fdt",  P_STRING|P_ALLOCED|P_VIM|P_VI_DEF|P_RWIN,
                            ...
                            {(char_u *)"foldtext()", (char_u *)NULL} SCRIPTID_INIT},
#endif
    ...
    {"isident",     "isi",  P_STRING|P_VI_DEF|P_COMMA|P_NODUP,
                            ...
                            {(char_u *)"@,48-57,_,192-255", (char_u *)0L} SCRIPTID_INIT},
    {"iskeyword",   "isk",  P_STRING|P_ALLOCED|P_VIM|P_COMMA|P_NODUP,
                            (char_u *)&p_isk, PV_ISK,
                            {(char_u *)"@,48-57,_", ISK_LATIN1} SCRIPTID_INIT},
    ...
    {"lines",       NULL,   P_NUM|P_NODEFAULT|P_NO_MKRC|P_VI_DEF|P_RCLR,
                            (char_u *)&Rows, PV_NONE,
                            {(char_u *)24L, (char_u *)0L} SCRIPTID_INIT},
    ...
    {"paragraphs",  "para", P_STRING|P_VI_DEF,
                            ...
                            {(char_u *)"IPLPPPQPP TPHPLIPpLpItpplpipbp", (char_u *)0L} SCRIPTID_INIT},
    ...
    {"path",        "pa",   P_STRING|P_EXPAND|P_VI_DEF|P_COMMA|P_NODUP,
                            ...
                            {(char_u *)".,/usr/include,,", (char_u *)0L} SCRIPTID_INIT},
   ...
   {"printmbcharset", "pmbcs",  P_STRING|P_VI_DEF,
    ...
    {"shellcmdflag","shcf", P_STRING|P_VI_DEF|P_SECURE,
                            ...
                            {(char_u *)"-c", (char_u *)0L} SCRIPTID_INIT},
    {"shellpipe",   "sp",   P_STRING|P_VI_DEF|P_SECURE,
#if defined(FEAT_QUICKFIX)
                            (char_u *)&p_sp, PV_NONE,
                            {(char_u *)"| tee", (char_u *)0L}
#else
                            (char_u *)NULL, PV_NONE,
                            {(char_u *)0L, (char_u *)0L}
#endif
...
set_init_1()
{
...
#if defined(FEAT_POSTSCRIPT) && (defined(MAC) || defined(hpux))
    ...
    set_string_default("pexpr", (char_u *)"system('lpr' . (&printdevice == '' ? '' : ' -P' . &printdevice) . ' ' . v:fname_in) . delete(v:fname_in) + v:shell_error");
#endif
