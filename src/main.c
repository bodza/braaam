...
#if (1) /* don't want a prototype for main() */
#if !defined(NO_VIM_MAIN) /* skip this for unittests */
    int
#if defined(VIMDLL)
_export
#endif
...
#if defined(USE_XSMP) || defined(FEAT_GUI_MSWIN)
/*
