...
#if defined(FEAT_VREPLACE) || defined(FEAT_EX_EXTRA) || defined(FEAT_GUI) || defined(FEAT_VIRTUALEDIT)
    int
chartabsize(p, col)
    char_u      *p;
    colnr_T     col;
...
#if defined(FEAT_TERMRESPONSE) || (defined(FEAT_GUI_GTK) && defined(FEAT_WINDOWS))
/*
